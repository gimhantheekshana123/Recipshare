...
add_action( 'widgets_init', 'appetizo_about_load_widget' );

function appetizo_about_load_widget() {
	register_widget( 'appetizo_about_widget' );
}

class appetizo_about_widget extends WP_Widget {
    ...
    {
		/* Widget settings. */
		$widget_ops = array( 'classname' => 'appetizo_about_widget', 'description' => __('An About Me Widget', 'appetizo') );

		/* Widget control settings. */
		$control_ops = array( 'width' => 250, 'height' => 350, 'id_base' => 'appetizo_about_widget' );

		/* Create the widget. */
        parent::__construct(  'appetizo_about_widget', __('Appetizo: About Me', 'appetizo'), $widget_ops, $control_ops );
	}
	...
	function form( $instance ) {
		...
		<!-- image url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'image' )); ?>"><?php esc_html_e( 'Image URL','appetizo' ); ?></label>
		...
		<!-- subtitle -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'subtitle' )); ?>"><?php esc_html_e( 'Sub title','appetizo' ); ?></label>
		...
		<!-- description -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'description' )); ?>"><?php esc_html_e( 'About me text','appetizo' ); ?></label>
		...
		<!-- autograph url -->
		<p>
			<label for="<?php echo esc_attr($this->get_field_id( 'signing' )); ?>"><?php esc_html_e( 'Autograph Image URL','appetizo' ); ?></label>
