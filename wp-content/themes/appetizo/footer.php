			...
			<div id="footer" class="clearfix">
				...
				<div class="footer-inside clearfix">
					...
					<div class="footer-copy clearfix">
						...
						<p class="copyright"> <?php if(get_theme_mod('footer_copyright')): echo wp_kses_post(get_theme_mod('footer_copyright', 'Copyright &copy; 2023. All Rights Reserved.')); else: ?> <?php _e( 'Copyright &copy; 2023. All Rights Reserved.', 'appetizo' ); ?> <?php endif; ?>  </p>

                        <div class="theme-author">
                            <?php if(get_theme_mod('footer_designed')): echo wp_kses_post(get_theme_mod('footer_designed')); else:

                                ?> <?php _e( 'Designed by', 'appetizo' ); ?> <a href="<?php echo esc_url( 'https://www.vinethemes.com/' ); ?>">
                                <?php esc_html_e( 'VineThemes', 'appetizo' ); ?>
                            </a> <?php
                            endif; ?>
